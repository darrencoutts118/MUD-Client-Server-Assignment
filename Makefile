...
assignment: 
	...
	javac cs3524/solutions/mud/Vertex.java; \
        ...
        javac cs3524/solutions/mud/MUDService.java; \
        javac cs3524/solutions/mud/MUDServiceImpl.java; \
...
auction:
	javac -Xlint:unchecked cs3524/examples/auction/AuctioneerImpl.java; \
	javac -Xlint:unchecked cs3524/examples/auction/AuctioneerInterface.java; \
	javac -Xlint:unchecked cs3524/examples/auction/AuctioneerMainline.java;	\ 
	javac -Xlint:unchecked cs3524/examples/auction/BidderImpl.java; \
	javac -Xlint:unchecked cs3524/examples/auction/BidderInterface.java; \
	javac -Xlint:unchecked cs3524/examples/auction/BidderMainline.java
